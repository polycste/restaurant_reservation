...
<!--<![endif]-->
	...
	<head>
		    ...
		    <title>Fish Kabab | sevenhillrestaurant</title>
...
<link rel="alternate" type="application/rss+xml" title="sevenhillrestaurant &raquo; Fish Kabab Comments Feed" href="menu-item/fish-kabab/feed/index.php" />
...
<link rel='prev' title='Beef Shish Kabab' href='index.php%3Fp=454.php' />
<link rel='next' title='Pasta' href='index.php%3Fp=462.php' />
<meta name="generator" content="WordPress 3.9.6" />
<link rel='canonical' href='index.php%3Fp=458.php' />
<link rel='shortlink' href='index.php%3Fp=458.php' />
...
<!-- end Responsive Select JS -->
	...
	<body class="single single-rm-menu-entry postid-458" itemscope itemtype="http://schema.org/WebPage">
...
<div id="main-wrapper " class="container">
    ...
    <div class="breadcrumb-trail breadcrumbs" itemprop="breadcrumb"><span class="trail-begin"><a href="index.php" title="sevenhillrestaurant" rel="home" class="trail-begin">Home</a></span> <span class="sep">&raquo;</span> <a href="menu-item/index.php" title="Menu Entries">Menu Entries</a> <span class="sep">&raquo;</span> <span class="trail-end">Fish Kabab</span></div><div class="tc-hot-crumble container" role="navigation"><div class="row"><div class="span12"></div></div></div>    
    <div class="container" role="main">
      ...
      <div class="span3 left tc-sidebar">
        ...
        <header class="entry-header">
          ...
          <h1 class="entry-title format-icon">Fish Kabab  </h1>
        ...
        <section class="entry-content ">
            <p>Fish Kabab &#8211; 4 cubs of grilled vatki fish with french fries / nan &#038; salad<br />
(Include 15% VAT)</p>
...
<div id="cancel-comment-reply">
	<small><a rel="nofollow" id="cancel-comment-reply-link" href="index.php%3Fp=458.php#respond" style="display:none;">Click here to cancel reply.</a></small>
</div>
...
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
        ...
        <nav id="nav-below" class="navigation" role="navigation">
            ...
            <ul class="pager">
                  ...
                  <span class="nav-previous">
                    <a href="index.php%3Fp=454.php" rel="prev"><span class="meta-nav">&larr;</span> Beef Shish Kabab</a>                  </span>
                </li>
                                            <li class="next">
                  <span class="nav-next">
                    <a href="index.php%3Fp=462.php" rel="next">Pasta <span class="meta-nav">&rarr;</span></a>                  </span>
                </li>
                          </ul>
	...
	<footer id="footer" class="">
             ...
             <div class="colophon ">
                <div class="container ">
                    <div class="row-fluid">
                        <div class="span4 social-block pull-left"><a class="" href="http://sevenhillrestaurant.net/feed/rss/" title="Suscribe to my rss feed"  ></a></div><div class="span4 credits"><p> &middot; &copy; 2015 <a href="index.php" title="sevenhillrestaurant" rel="bookmark">sevenhillrestaurant</a> &middot; Designed by DK Technology</p></div><div class="span4 backtop"><p class="pull-right"><a class="back-to-top" href="index.php%3Fp=458.php#">Back to top</a></p></div>                    </div><!-- .row-fluid -->
                </div><!-- .container -->
            </div><!-- .colophon -->
